...
as.numeric(factor)
```
Applying this function to the logical variable codes "FALSE" as 0 and "TRUE" as 1. This explains how the mean of the logical variable came out to be 0.6. Applying this function to the character variable just causes all of the values to be missing, or "NA", explaining why taking the mean results in an error. Finally, the factor variable.....
